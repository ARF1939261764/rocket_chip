    ...
    , TOP____024unit{this, Verilated::catName(namep, "$unit")}
{
    ...
    __Vscope_TestDriver__testHarness__chiptop0__system__subsystem_sbus__coupler_to_port_named_mmio_port_axi4__axi4deint.configure(this, name(), "TestDriver.testHarness.chiptop0.system.subsystem_sbus.coupler_to_port_named_mmio_port_axi4.axi4deint", "axi4deint", -9, VerilatedScope::SCOPE_OTHER);
    __Vscope_TestDriver__testHarness__chiptop0__system__subsystem_sbus__coupler_to_port_named_mmio_port_axi4__axi4yank.configure(this, name(), "TestDriver.testHarness.chiptop0.system.subsystem_sbus.coupler_to_port_named_mmio_port_axi4.axi4yank", "axi4yank", -9, VerilatedScope::SCOPE_OTHER);
    __Vscope_TestDriver__testHarness__chiptop0__system__subsystem_sbus__coupler_to_port_named_mmio_port_axi4__tl2axi4.configure(this, name(), "TestDriver.testHarness.chiptop0.system.subsystem_sbus.coupler_to_port_named_mmio_port_axi4.tl2axi4", "tl2axi4", -9, VerilatedScope::SCOPE_OTHER);
    __Vscope_TestDriver__testHarness__chiptop0__system__subsystem_sbus__coupler_to_port_named_mmio_port_axi4__tl2axi4__monitor.configure(this, name(), "TestDriver.testHarness.chiptop0.system.subsystem_sbus.coupler_to_port_named_mmio_port_axi4.tl2axi4.monitor", "monitor", -9, VerilatedScope::SCOPE_OTHER);
    ...
    __Vscope_TestDriver__testHarness__chiptop0__system__subsystem_sbus__fixer__monitor_3.configure(this, name(), "TestDriver.testHarness.chiptop0.system.subsystem_sbus.fixer.monitor_3", "monitor_3", -9, VerilatedScope::SCOPE_OTHER);
    __Vscope_TestDriver__testHarness__chiptop0__system__subsystem_sbus__fixer__monitor_4.configure(this, name(), "TestDriver.testHarness.chiptop0.system.subsystem_sbus.fixer.monitor_4", "monitor_4", -9, VerilatedScope::SCOPE_OTHER);
