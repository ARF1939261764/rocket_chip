...
module TLMonitor_26(
  ...
  wire         _T_1553 = io_in_a_ready & io_in_a_valid;	// @[Decoupled.scala:51:35]
  ...
  wire         _T_1477 = _T_1553 & a_first_1;	// @[Decoupled.scala:51:35, Edges.scala:231:25, Monitor.scala:652:27]
  ...
  wire [514:0] _a_opcodes_set_T_1 = {511'h0, _T_1477 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << {507'h0, io_in_a_bits_source, 2'h0};	// @[Monitor.scala:42:11, :643:40, :652:{27,72}, :654:{28,53}, :656:54, :657:52, Parameters.scala:52:29, :54:32]
  wire [526:0] _d_sizes_clr_T_5 = 527'hFF << {518'h0, io_in_d_bits_source, 3'h0};	// @[Misc.scala:201:34, Monitor.scala:677:76, :678:74]
  wire [515:0] _a_sizes_set_T_1 = {511'h0, _T_1477 ? {io_in_a_bits_size, 1'h1} : 5'h0} << {507'h0, io_in_a_bits_source, 3'h0};	// @[Misc.scala:201:34, Monitor.scala:42:11, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52]
  wire         _T_1626 = io_in_d_ready & io_in_d_valid;	// @[Decoupled.scala:51:35]
  wire         _T_1492 = _T_1626 & d_first_1 & ~d_release_ack;	// @[Decoupled.scala:51:35, Edges.scala:231:25, Monitor.scala:670:46, :671:74, :675:72]
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (_T_1553) begin	// @[Decoupled.scala:51:35]
      ...
      if (_T_1626) begin	// @[Decoupled.scala:51:35]
      ...
      inflight <= (inflight | (_T_1477 ? _a_set_T[32:0] : 33'h0)) & ~(_T_1492 ? _d_clr_T[32:0] : 33'h0);	// @[Monitor.scala:611:27, :623:34, :652:{27,72}, :653:28, :661:34, :675:{72,91}, :676:21, :702:{27,36,38}, :723:35, OneHot.scala:57:35]
      inflight_opcodes <= (inflight_opcodes | (_T_1477 ? _a_opcodes_set_T_1[131:0] : 132'h0)) & ~(_T_1492 ? _d_opcodes_clr_T_5[131:0] : 132'h0);	// @[Monitor.scala:613:35, :627:33, :652:{27,72}, :656:{28,54}, :665:33, :675:{72,91}, :677:{21,76}, :703:{43,60,62}, :724:35]
      inflight_sizes <= (inflight_sizes | (_T_1477 ? _a_sizes_set_T_1[263:0] : 264'h0)) & ~(_T_1492 ? _d_sizes_clr_T_5[263:0] : 264'h0);	// @[Monitor.scala:615:33, :629:31, :652:{27,72}, :657:{28,52}, :667:31, :675:{72,91}, :678:{21,74}, :704:{39,54,56}, :725:35]
      if (_T_1553 | _T_1626)	// @[Decoupled.scala:51:35, Monitor.scala:712:27]
        watchdog <= 32'h0;	// @[Monitor.scala:706:27]
      else	// @[Monitor.scala:712:27]
        watchdog <= watchdog + 32'h1;	// @[Monitor.scala:706:27, :711:26]
    end
    if (_T_1553 & ~(|a_first_counter)) begin	// @[Decoupled.scala:51:35, Edges.scala:229:27, :231:25, Monitor.scala:396:20]
    ...
    if (_T_1626 & ~(|d_first_counter)) begin	// @[Decoupled.scala:51:35, Edges.scala:229:27, :231:25, Monitor.scala:549:20]
  ...
  `ifndef SYNTHESIS
    ...
    wire             _WIRE_2_1 = io_in_a_bits_source == 6'h1C;	// @[Parameters.scala:46:9]
    wire             _source_ok_WIRE_2 = io_in_a_bits_source == 6'h1D;	// @[Parameters.scala:46:9]
    wire             _source_ok_WIRE_3 = io_in_a_bits_source == 6'h1E;	// @[Parameters.scala:46:9]
    wire             _WIRE_2_4 = io_in_a_bits_source == 6'h18;	// @[Parameters.scala:46:9]
    wire             _source_ok_WIRE_5 = io_in_a_bits_source == 6'h19;	// @[Parameters.scala:46:9]
    wire             _source_ok_WIRE_6 = io_in_a_bits_source == 6'h1A;	// @[Parameters.scala:46:9]
    wire             _WIRE_2_7 = io_in_a_bits_source == 6'h14;	// @[Parameters.scala:46:9]
    wire             _source_ok_WIRE_8 = io_in_a_bits_source == 6'h15;	// @[Parameters.scala:46:9]
    wire             _source_ok_WIRE_9 = io_in_a_bits_source == 6'h16;	// @[Parameters.scala:46:9]
    wire             _WIRE_2_10 = io_in_a_bits_source == 6'h10;	// @[Parameters.scala:46:9]
    wire             _source_ok_WIRE_11 = io_in_a_bits_source == 6'h11;	// @[Parameters.scala:46:9]
    wire             _source_ok_WIRE_12 = io_in_a_bits_source == 6'h12;	// @[Parameters.scala:46:9]
    wire             _source_ok_WIRE_13 = io_in_a_bits_source == 6'h20;	// @[Parameters.scala:46:9]
    wire             source_ok = ~(|(io_in_a_bits_source[5:4])) | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _WIRE_2_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _WIRE_2_7 | _source_ok_WIRE_8 | _source_ok_WIRE_9 | _WIRE_2_10 | _source_ok_WIRE_11 | _source_ok_WIRE_12 | _source_ok_WIRE_13;	// @[Parameters.scala:46:9, :54:{10,32}, :1126:46]
    ...
    wire             _T_561 = io_in_a_bits_size > 4'h2;	// @[Misc.scala:205:21]
    wire             mask_size = io_in_a_bits_size[1:0] == 2'h2;	// @[Bundles.scala:111:27, Misc.scala:208:26, OneHot.scala:63:49]
    wire             mask_acc = _T_561 | mask_size & ~(io_in_a_bits_address[2]);	// @[Misc.scala:205:21, :208:26, :209:26, :210:20, :214:{29,38}]
    wire             mask_acc_1 = _T_561 | mask_size & io_in_a_bits_address[2];	// @[Misc.scala:205:21, :208:26, :209:26, :214:{29,38}]
    ...
    wire             _T_251 = io_in_a_bits_size == 4'h6;	// @[Parameters.scala:91:48]
    ...
    wire             _T_473 = io_in_a_bits_size == 4'h6;	// @[Parameters.scala:91:48]
    ...
    wire             _T_746 = io_in_a_bits_size < 4'hD;	// @[Parameters.scala:92:42]
    wire             _GEN_14 = io_in_a_valid & io_in_a_bits_opcode == 3'h1;	// @[Misc.scala:201:81, Monitor.scala:122:{25,56}]
    wire             _T_862 = io_in_a_bits_size < 4'hD;	// @[Parameters.scala:92:42]
    ...
    wire             source_ok_1 = io_in_d_bits_source[5:4] == 2'h0 | io_in_d_bits_source == 6'h1C | io_in_d_bits_source == 6'h1D | io_in_d_bits_source == 6'h1E | io_in_d_bits_source == 6'h18 | io_in_d_bits_source == 6'h19 | io_in_d_bits_source == 6'h1A | io_in_d_bits_source == 6'h14 | io_in_d_bits_source == 6'h15 | io_in_d_bits_source == 6'h16 | io_in_d_bits_source == 6'h10 | io_in_d_bits_source == 6'h11 | io_in_d_bits_source == 6'h12 | io_in_d_bits_source == 6'h20;	// @[Parameters.scala:46:9, :54:{10,32}, :1126:46]
    ...
    wire             _T_1422 = io_in_a_valid & (|a_first_counter);	// @[Edges.scala:229:27, :231:25, Monitor.scala:389:19]
    wire             _T_1446 = io_in_d_valid & (|d_first_counter);	// @[Edges.scala:229:27, :231:25, Monitor.scala:541:19]
    ...
    wire             _T_1525 = io_in_d_valid & d_first_1;	// @[Edges.scala:231:25, Monitor.scala:671:26]
    wire             _T_1496 = _T_1525 & ~d_release_ack;	// @[Monitor.scala:670:46, :671:{26,74}, :680:71]
    ...
    wire             _GEN_28 = _T_1496 & same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire             _GEN_29 = _T_1496 & ~same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire  [7:0]      _GEN_30 = {4'h0, io_in_d_bits_size};	// @[Monitor.scala:691:36, Parameters.scala:52:29]
    wire             _T_1582 = io_in_d_valid & d_first_2 & d_release_ack;	// @[Edges.scala:231:25, Monitor.scala:670:46, :791:71]
    wire  [32:0]     _T_1478 = inflight >> io_in_a_bits_source;	// @[Monitor.scala:611:27, :658:26]
    wire  [32:0]     _T_1497 = inflight >> _GEN_27;	// @[Monitor.scala:611:27, :682:25]
    ...
    wire  [32:0]     _T_1583 = 33'h0 >> _GEN_27;	// @[Monitor.scala:682:25, :723:35, :793:25]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_6 & ~reset & ~_T_561) begin	// @[Misc.scala:205:21, Monitor.scala:42:11, :81:54]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & ~((_WIRE_2_1 & _T_473 | _WIRE_2_4 & _T_473 | _WIRE_2_7 & _T_473 | _WIRE_2_10 & _T_473) & io_in_a_bits_size < 4'hD & (_GEN_7 == 18'h0 | io_in_a_bits_address[30:12] == 19'h3 | io_in_a_bits_address[30:16] == 15'h1 | _GEN_8 == 18'h0 | io_in_a_bits_address[30:16] == 15'h200 | io_in_a_bits_address[30:12] == 19'h2010 | io_in_a_bits_address[30:26] == 5'h3 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :92:53, :94:78, :706:27, Mux.scala:27:73, Parameters.scala:46:9, :91:48, :92:42, :137:{31,45,65}, :672:42]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & ~_T_561) begin	// @[Misc.scala:205:21, Monitor.scala:42:11, :92:53]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_11 & ~reset & ~(_T_629 & (~(|(io_in_a_bits_source[5:4])) | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _WIRE_2_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _WIRE_2_7 | _source_ok_WIRE_8 | _source_ok_WIRE_9 | _WIRE_2_10 | _source_ok_WIRE_11 | _source_ok_WIRE_12 | _source_ok_WIRE_13))) begin	// @[Monitor.scala:42:11, :104:45, Parameters.scala:46:9, :54:{10,32}, :92:42, :1161:30, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
          $error("Assertion failed: 'A' channel carries Get type which master claims it can't emit (connected at PeripheryBus.scala:58:7)\n    at Monitor.scala:42 assert(cond, message)\n");	// @[Monitor.scala:42:11]
        if (`STOP_COND_)	// @[Monitor.scala:42:11]
          $fatal;	// @[Monitor.scala:42:11]
      end
      if (_GEN_11 & ~reset & ~(_T_629 & io_in_a_bits_address[30:12] == 19'h3 | io_in_a_bits_size < 4'h7 & (_GEN_7 == 18'h0 | io_in_a_bits_address[30:16] == 15'h1 | _GEN_8 == 18'h0 | io_in_a_bits_address[30:16] == 15'h200 | io_in_a_bits_address[30:12] == 19'h2010 | io_in_a_bits_address[30:26] == 5'h3 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :104:45, :706:27, Parameters.scala:92:42, :137:{31,45,65}, :671:54, :672:42, :673:26]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_13 & ~reset & ~(_T_746 & (~(|(io_in_a_bits_source[5:4])) | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _WIRE_2_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _WIRE_2_7 | _source_ok_WIRE_8 | _source_ok_WIRE_9 | _WIRE_2_10 | _source_ok_WIRE_11 | _source_ok_WIRE_12 | _source_ok_WIRE_13) & (_T_746 & io_in_a_bits_address[30:12] == 19'h3 | io_in_a_bits_size < 4'h7 & (_GEN_7 == 18'h0 | _GEN_8 == 18'h0 | io_in_a_bits_address[30:16] == 15'h200 | io_in_a_bits_address[30:12] == 19'h2010 | io_in_a_bits_address[30:26] == 5'h3 | io_in_a_bits_address[30:12] == 19'h54000)))) begin	// @[Monitor.scala:42:11, :114:53, :115:71, :706:27, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:{31,45,65}, :671:54, :672:42, :673:26, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_14 & ~reset & ~(_T_862 & (~(|(io_in_a_bits_source[5:4])) | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _WIRE_2_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _WIRE_2_7 | _source_ok_WIRE_8 | _source_ok_WIRE_9 | _WIRE_2_10 | _source_ok_WIRE_11 | _source_ok_WIRE_12 | _source_ok_WIRE_13) & (_T_862 & io_in_a_bits_address[30:12] == 19'h3 | io_in_a_bits_size < 4'h7 & (_GEN_7 == 18'h0 | _GEN_8 == 18'h0 | io_in_a_bits_address[30:16] == 15'h200 | io_in_a_bits_address[30:12] == 19'h2010 | io_in_a_bits_address[30:26] == 5'h3 | io_in_a_bits_address[30:12] == 19'h54000)))) begin	// @[Monitor.scala:42:11, :122:56, :123:74, :706:27, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:{31,45,65}, :671:54, :672:42, :673:26, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_15 & ~reset & ~(io_in_a_bits_size < 4'hD & (~(|(io_in_a_bits_source[5:4])) | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _WIRE_2_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _WIRE_2_7 | _source_ok_WIRE_8 | _source_ok_WIRE_9 | _WIRE_2_10 | _source_ok_WIRE_11 | _source_ok_WIRE_12 | _source_ok_WIRE_13) & io_in_a_bits_size < 4'h4 & (_GEN_7 == 18'h0 | io_in_a_bits_address[30:12] == 19'h3 | _GEN_8 == 18'h0 | io_in_a_bits_address[30:16] == 15'h200 | io_in_a_bits_address[30:12] == 19'h2010 | io_in_a_bits_address[30:26] == 5'h3 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :130:56, :131:74, :706:27, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:{31,45,65}, :672:42, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_16 & ~reset & ~(io_in_a_bits_size < 4'hD & (~(|(io_in_a_bits_source[5:4])) | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _WIRE_2_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _WIRE_2_7 | _source_ok_WIRE_8 | _source_ok_WIRE_9 | _WIRE_2_10 | _source_ok_WIRE_11 | _source_ok_WIRE_12 | _source_ok_WIRE_13) & io_in_a_bits_size < 4'h4 & (_GEN_7 == 18'h0 | io_in_a_bits_address[30:12] == 19'h3 | _GEN_8 == 18'h0 | io_in_a_bits_address[30:16] == 15'h200 | io_in_a_bits_address[30:12] == 19'h2010 | io_in_a_bits_address[30:26] == 5'h3 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :138:53, :139:71, :706:27, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:{31,45,65}, :672:42, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_17 & ~reset & ~(io_in_a_bits_size < 4'hD & (~(|(io_in_a_bits_source[5:4])) | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _WIRE_2_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _WIRE_2_7 | _source_ok_WIRE_8 | _source_ok_WIRE_9 | _WIRE_2_10 | _source_ok_WIRE_11 | _source_ok_WIRE_12 | _source_ok_WIRE_13) & io_in_a_bits_address[30:12] == 19'h3)) begin	// @[Monitor.scala:42:11, :146:46, :147:68, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:{31,65}, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_T_1525 & a_first_1 & io_in_a_valid & io_in_a_bits_source == io_in_d_bits_source & ~d_release_ack & ~reset & ~(~io_in_d_ready | io_in_a_ready)) begin	// @[Edges.scala:231:25, Monitor.scala:49:11, :670:46, :671:{26,74}, :694:90, :695:{15,32}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: ready check\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (~reset & ~(a_set_wo_ready != (_T_1525 & ~d_release_ack ? _d_clr_wo_ready_T[32:0] : 33'h0) | a_set_wo_ready == 33'h0)) begin	// @[Monitor.scala:49:11, :624:34, :648:71, :649:22, :662:34, :670:46, :671:{26,71,74,90}, :672:22, :699:{29,48,67}, :723:35, OneHot.scala:57:35]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_T_1582 & ~reset & ~(_T_1583[0])) begin	// @[Monitor.scala:49:11, :791:71, :793:25]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel acknowledged for nothing inflight (connected at PeripheryBus.scala:58:7)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (_T_1582 & ~reset & _GEN_30 != {1'h0, _c_size_lookup_T_1[7:1]}) begin	// @[Monitor.scala:42:11, :49:11, :691:36, :747:{21,42}, :791:71, :797:36]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel contains improper response size (connected at PeripheryBus.scala:58:7)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
