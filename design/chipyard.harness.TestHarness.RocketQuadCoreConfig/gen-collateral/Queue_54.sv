...
module Queue_54(
  ...
  assign io_deq_bits_addr = _ram_ext_R0_data[35:5];	// @[Decoupled.scala:273:95]
  ...
  assign io_deq_bits_echo_tl_state_source = _ram_ext_R0_data[69:65];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_wen = _ram_ext_R0_data[70];	// @[Decoupled.scala:273:95]
endmodule
