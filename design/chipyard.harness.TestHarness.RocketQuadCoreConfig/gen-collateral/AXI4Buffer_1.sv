...
module AXI4Buffer_1(
  ...
  Queue_136 x1_aw_deq (	// @[Decoupled.scala:375:21]
    .clock                      (clock),
    .reset                      (reset),
  ...
  Queue_138 bundleIn_0_b_deq (	// @[Decoupled.scala:375:21]
    .clock                      (clock),
    .reset                      (reset),
  ...
  Queue_136 x1_ar_deq (	// @[Decoupled.scala:375:21]
    .clock                      (clock),
    .reset                      (reset),
  ...
  Queue_140 bundleIn_0_r_deq (	// @[Decoupled.scala:375:21]
    .clock                      (clock),
    .reset                      (reset),
