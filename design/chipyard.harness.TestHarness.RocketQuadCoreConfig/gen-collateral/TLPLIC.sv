...
module TLPLIC(
  ...
  wire        out_woready_16;	// @[RegisterRouter.scala:83:24]
  ...
  wire        _out_T_35 = {_out_back_io_deq_bits_index[22:19], _out_back_io_deq_bits_index[17:12], _out_back_io_deq_bits_index[8:7], _out_back_io_deq_bits_index[3:0]} == 16'h0;	// @[Decoupled.scala:375:21, RegisterRouter.scala:83:24]
  wire [31:0] _out_womask_T_25 = {{8{_out_back_io_deq_bits_mask[7]}}, {8{_out_back_io_deq_bits_mask[6]}}, {8{_out_back_io_deq_bits_mask[5]}}, {8{_out_back_io_deq_bits_mask[4]}}};	// @[Bitwise.scala:28:17, :77:12, Decoupled.scala:375:21, RegisterRouter.scala:83:24]
  wire        claimer_5 = _out_rofireMux_T_1 & out_backSel_104 & _out_T_35 & (|_out_womask_T_25);	// @[RegisterRouter.scala:83:24]
  wire [1:0]  _out_completer_5_T = {enables_5_0, 1'h0} >> _GEN;	// @[Cat.scala:33:92, OneHot.scala:64:12, Plic.scala:163:31, :174:26, :295:51]
  assign completer_5 = out_woready_2 & (&_out_womask_T_25) & _out_completer_5_T[0];	// @[Plic.scala:295:{35,51}, RegisterRouter.scala:83:24]
  wire        claimer_4 = _out_rofireMux_T_1 & out_backSel_96 & _out_T_35 & (|_out_womask_T_25);	// @[RegisterRouter.scala:83:24]
  wire [1:0]  _out_completer_4_T = {enables_4_0, 1'h0} >> _GEN;	// @[Cat.scala:33:92, OneHot.scala:64:12, Plic.scala:163:31, :174:26, :295:51]
  assign completer_4 = out_woready_7 & (&_out_womask_T_25) & _out_completer_4_T[0];	// @[Plic.scala:295:{35,51}, RegisterRouter.scala:83:24]
  wire        claimer_1 = _out_rofireMux_T_1 & out_backSel_72 & _out_T_35 & (|_out_womask_T_25);	// @[RegisterRouter.scala:83:24]
  wire [1:0]  _out_completer_1_T = {enables_1_0, 1'h0} >> _GEN;	// @[Cat.scala:33:92, OneHot.scala:64:12, Plic.scala:163:31, :174:26, :295:51]
  assign completer_1 = out_woready_10 & (&_out_womask_T_25) & _out_completer_1_T[0];	// @[Plic.scala:295:{35,51}, RegisterRouter.scala:83:24]
  wire        claimer_3 = _out_rofireMux_T_1 & out_backSel_88 & _out_T_35 & (|_out_womask_T_25);	// @[RegisterRouter.scala:83:24]
  wire [1:0]  _out_completer_3_T = {enables_3_0, 1'h0} >> _GEN;	// @[Cat.scala:33:92, OneHot.scala:64:12, Plic.scala:163:31, :174:26, :295:51]
  assign completer_3 = out_woready_13 & (&_out_womask_T_25) & _out_completer_3_T[0];	// @[Plic.scala:295:{35,51}, RegisterRouter.scala:83:24]
  wire        claimer_7 = _out_rofireMux_T_1 & out_backSel_120 & _out_T_35 & (|_out_womask_T_25);	// @[RegisterRouter.scala:83:24]
  wire [1:0]  _out_completer_7_T = {enables_7_0, 1'h0} >> _GEN;	// @[Cat.scala:33:92, OneHot.scala:64:12, Plic.scala:163:31, :174:26, :295:51]
  assign completer_7 = out_woready_16 & (&_out_womask_T_25) & _out_completer_7_T[0];	// @[Plic.scala:295:{35,51}, RegisterRouter.scala:83:24]
  wire        claimer_0 = _out_rofireMux_T_1 & out_backSel_64 & _out_T_35 & (|_out_womask_T_25);	// @[RegisterRouter.scala:83:24]
  wire [1:0]  _out_completer_0_T = {enables_0_0, 1'h0} >> _GEN;	// @[Cat.scala:33:92, OneHot.scala:64:12, Plic.scala:163:31, :174:26, :295:51]
  assign completer_0 = out_woready_19 & (&_out_womask_T_25) & _out_completer_0_T[0];	// @[Plic.scala:295:{35,51}, RegisterRouter.scala:83:24]
  wire        claimer_2 = _out_rofireMux_T_1 & out_backSel_80 & _out_T_35 & (|_out_womask_T_25);	// @[RegisterRouter.scala:83:24]
  wire [1:0]  _out_completer_2_T = {enables_2_0, 1'h0} >> _GEN;	// @[Cat.scala:33:92, OneHot.scala:64:12, Plic.scala:163:31, :174:26, :295:51]
  assign completer_2 = out_woready_22 & (&_out_womask_T_25) & _out_completer_2_T[0];	// @[Plic.scala:295:{35,51}, RegisterRouter.scala:83:24]
  wire        claimer_6 = _out_rofireMux_T_1 & out_backSel_112 & _out_T_35 & (|_out_womask_T_25);	// @[RegisterRouter.scala:83:24]
  ...
  assign completer_6 = out_woready_25 & (&_out_womask_T_25) & _out_completer_6_T[0];	// @[Plic.scala:295:{35,51}, RegisterRouter.scala:83:24]
  wire [6:0]  out_oindex = {_out_back_io_deq_bits_index[18], _out_back_io_deq_bits_index[11:9], _out_back_io_deq_bits_index[6:4]};	// @[Cat.scala:33:92, Decoupled.scala:375:21, RegisterRouter.scala:83:24]
  wire [6:0]  _GEN_0 = {_out_back_io_deq_bits_index[18], _out_back_io_deq_bits_index[11:9], _out_back_io_deq_bits_index[6:4]};	// @[Cat.scala:33:92, Decoupled.scala:375:21, OneHot.scala:57:35, RegisterRouter.scala:83:24]
  assign out_backSel_64 = _GEN_0 == 7'h40;	// @[MuxLiteral.scala:54:22, OneHot.scala:57:35, RegisterRouter.scala:83:24]
  assign out_backSel_72 = _GEN_0 == 7'h48;	// @[MuxLiteral.scala:54:22, OneHot.scala:57:35, RegisterRouter.scala:83:24]
  assign out_backSel_80 = _GEN_0 == 7'h50;	// @[MuxLiteral.scala:54:22, OneHot.scala:57:35, RegisterRouter.scala:83:24]
  assign out_backSel_88 = _GEN_0 == 7'h58;	// @[MuxLiteral.scala:54:22, OneHot.scala:57:35, RegisterRouter.scala:83:24]
  assign out_backSel_96 = _GEN_0 == 7'h60;	// @[MuxLiteral.scala:54:22, OneHot.scala:57:35, RegisterRouter.scala:83:24]
  assign out_backSel_104 = _GEN_0 == 7'h68;	// @[MuxLiteral.scala:54:22, OneHot.scala:57:35, RegisterRouter.scala:83:24]
  assign out_backSel_112 = _GEN_0 == 7'h70;	// @[MuxLiteral.scala:54:22, OneHot.scala:57:35, RegisterRouter.scala:83:24]
  assign out_backSel_120 = _GEN_0 == 7'h78;	// @[MuxLiteral.scala:54:22, OneHot.scala:57:35, RegisterRouter.scala:83:24]
  ...
  assign out_woready_19 = _out_wofireMux_T_2 & out_backSel_64 & _out_T_35;	// @[RegisterRouter.scala:83:24]
  assign out_woready_10 = _out_wofireMux_T_2 & out_backSel_72 & _out_T_35;	// @[RegisterRouter.scala:83:24]
  assign out_woready_22 = _out_wofireMux_T_2 & out_backSel_80 & _out_T_35;	// @[RegisterRouter.scala:83:24]
  assign out_woready_13 = _out_wofireMux_T_2 & out_backSel_88 & _out_T_35;	// @[RegisterRouter.scala:83:24]
  assign out_woready_7 = _out_wofireMux_T_2 & out_backSel_96 & _out_T_35;	// @[RegisterRouter.scala:83:24]
  assign out_woready_2 = _out_wofireMux_T_2 & out_backSel_104 & _out_T_35;	// @[RegisterRouter.scala:83:24]
  assign out_woready_25 = _out_wofireMux_T_2 & out_backSel_112 & _out_T_35;	// @[RegisterRouter.scala:83:24]
  assign out_woready_16 = _out_wofireMux_T_2 & out_backSel_120 & _out_T_35;	// @[RegisterRouter.scala:83:24]
  wire        _out_out_bits_data_T_18 = out_oindex == 7'h0;	// @[Cat.scala:33:92, MuxLiteral.scala:54:22]
  ...
  wire        claimedDevs_1 = claimer_0 & maxDevs_0 | claimer_1 & maxDevs_1 | claimer_2 & maxDevs_2 | claimer_3 & maxDevs_3 | claimer_4 & maxDevs_4 | claimer_5 & maxDevs_5 | claimer_6 & maxDevs_6 | claimer_7 & maxDevs_7;	// @[Plic.scala:181:22, :246:{49,92}, RegisterRouter.scala:83:24]
  always @(posedge clock) begin
    if (_out_wofireMux_T_2 & _GEN_0 == 7'h0 & _out_T_35 & _out_back_io_deq_bits_mask[4])	// @[Bitwise.scala:28:17, Decoupled.scala:375:21, MuxLiteral.scala:54:22, OneHot.scala:57:35, RegisterRouter.scala:83:24]
    ...
    if (_out_wofireMux_T_2 & _GEN_0 == 7'h10 & _out_T_35 & _out_back_io_deq_bits_mask[0])	// @[Bitwise.scala:28:17, Decoupled.scala:375:21, MuxLiteral.scala:54:22, OneHot.scala:57:35, RegisterRouter.scala:83:24]
      enables_0_0 <= _out_back_io_deq_bits_data[1];	// @[Decoupled.scala:375:21, Plic.scala:174:26, RegisterRouter.scala:83:24]
    if (_out_wofireMux_T_2 & _GEN_0 == 7'h11 & _out_T_35 & _out_back_io_deq_bits_mask[0])	// @[Bitwise.scala:28:17, Decoupled.scala:375:21, MuxLiteral.scala:54:22, OneHot.scala:57:35, RegisterRouter.scala:83:24]
      enables_1_0 <= _out_back_io_deq_bits_data[1];	// @[Decoupled.scala:375:21, Plic.scala:174:26, RegisterRouter.scala:83:24]
    if (_out_wofireMux_T_2 & _GEN_0 == 7'h12 & _out_T_35 & _out_back_io_deq_bits_mask[0])	// @[Bitwise.scala:28:17, Decoupled.scala:375:21, MuxLiteral.scala:54:22, OneHot.scala:57:35, RegisterRouter.scala:83:24]
      enables_2_0 <= _out_back_io_deq_bits_data[1];	// @[Decoupled.scala:375:21, Plic.scala:174:26, RegisterRouter.scala:83:24]
    if (_out_wofireMux_T_2 & _GEN_0 == 7'h13 & _out_T_35 & _out_back_io_deq_bits_mask[0])	// @[Bitwise.scala:28:17, Decoupled.scala:375:21, MuxLiteral.scala:54:22, OneHot.scala:57:35, RegisterRouter.scala:83:24]
      enables_3_0 <= _out_back_io_deq_bits_data[1];	// @[Decoupled.scala:375:21, Plic.scala:174:26, RegisterRouter.scala:83:24]
    if (_out_wofireMux_T_2 & _GEN_0 == 7'h14 & _out_T_35 & _out_back_io_deq_bits_mask[0])	// @[Bitwise.scala:28:17, Decoupled.scala:375:21, MuxLiteral.scala:54:22, OneHot.scala:57:35, RegisterRouter.scala:83:24]
      enables_4_0 <= _out_back_io_deq_bits_data[1];	// @[Decoupled.scala:375:21, Plic.scala:174:26, RegisterRouter.scala:83:24]
    if (_out_wofireMux_T_2 & _GEN_0 == 7'h15 & _out_T_35 & _out_back_io_deq_bits_mask[0])	// @[Bitwise.scala:28:17, Decoupled.scala:375:21, MuxLiteral.scala:54:22, OneHot.scala:57:35, RegisterRouter.scala:83:24]
      enables_5_0 <= _out_back_io_deq_bits_data[1];	// @[Decoupled.scala:375:21, Plic.scala:174:26, RegisterRouter.scala:83:24]
    if (_out_wofireMux_T_2 & _GEN_0 == 7'h16 & _out_T_35 & _out_back_io_deq_bits_mask[0])	// @[Bitwise.scala:28:17, Decoupled.scala:375:21, MuxLiteral.scala:54:22, OneHot.scala:57:35, RegisterRouter.scala:83:24]
      enables_6_0 <= _out_back_io_deq_bits_data[1];	// @[Decoupled.scala:375:21, Plic.scala:174:26, RegisterRouter.scala:83:24]
    if (_out_wofireMux_T_2 & _GEN_0 == 7'h17 & _out_T_35 & _out_back_io_deq_bits_mask[0])	// @[Bitwise.scala:28:17, Decoupled.scala:375:21, MuxLiteral.scala:54:22, OneHot.scala:57:35, RegisterRouter.scala:83:24]
  ...
  `ifndef SYNTHESIS
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        pending_0 = _RANDOM_0[9];	// @[Plic.scala:163:31, :168:26]
        enables_0_0 = _RANDOM_0[10];	// @[Plic.scala:163:31, :174:26]
        enables_1_0 = _RANDOM_0[11];	// @[Plic.scala:163:31, :174:26]
        enables_2_0 = _RANDOM_0[12];	// @[Plic.scala:163:31, :174:26]
        enables_3_0 = _RANDOM_0[13];	// @[Plic.scala:163:31, :174:26]
        enables_4_0 = _RANDOM_0[14];	// @[Plic.scala:163:31, :174:26]
        enables_5_0 = _RANDOM_0[15];	// @[Plic.scala:163:31, :174:26]
        enables_6_0 = _RANDOM_0[16];	// @[Plic.scala:163:31, :174:26]
        enables_7_0 = _RANDOM_0[17];	// @[Plic.scala:163:31, :174:26]
        maxDevs_0 = _RANDOM_0[18];	// @[Plic.scala:163:31, :181:22]
        maxDevs_1 = _RANDOM_0[19];	// @[Plic.scala:163:31, :181:22]
        maxDevs_2 = _RANDOM_0[20];	// @[Plic.scala:163:31, :181:22]
        maxDevs_3 = _RANDOM_0[21];	// @[Plic.scala:163:31, :181:22]
        maxDevs_4 = _RANDOM_0[22];	// @[Plic.scala:163:31, :181:22]
        maxDevs_5 = _RANDOM_0[23];	// @[Plic.scala:163:31, :181:22]
        maxDevs_6 = _RANDOM_0[24];	// @[Plic.scala:163:31, :181:22]
        maxDevs_7 = _RANDOM_0[25];	// @[Plic.scala:163:31, :181:22]
        x1_0_REG = _RANDOM_0[26];	// @[Plic.scala:163:31, :188:45]
        bundleOut_1_0_REG = _RANDOM_0[27];	// @[Plic.scala:163:31, :188:45]
        bundleOut_2_0_REG = _RANDOM_0[28];	// @[Plic.scala:163:31, :188:45]
        bundleOut_3_0_REG = _RANDOM_0[29];	// @[Plic.scala:163:31, :188:45]
        bundleOut_4_0_REG = _RANDOM_0[30];	// @[Plic.scala:163:31, :188:45]
        bundleOut_5_0_REG = _RANDOM_0[31];	// @[Plic.scala:163:31, :188:45]
        bundleOut_6_0_REG = _RANDOM_1[0];	// @[Plic.scala:188:45]
        bundleOut_7_0_REG = _RANDOM_1[1];	// @[Plic.scala:188:45]
      `endif // RANDOMIZE_REG_INIT
    end // initial
  ...
  LevelGateway gateways_gateway (	// @[Plic.scala:156:27]
    ...
    .io_plic_complete ((completer_0 | completer_1 | completer_2 | completer_3 | completer_4 | completer_5 | completer_6 | completer_7) & completerDev),	// @[Plic.scala:264:{28,48}, :295:35, RegisterRouter.scala:83:24, package.scala:155:13]
  ...
  Queue_129 out_back (	// @[Decoupled.scala:375:21]
    .clock                               (clock),
    .reset                               (reset),
