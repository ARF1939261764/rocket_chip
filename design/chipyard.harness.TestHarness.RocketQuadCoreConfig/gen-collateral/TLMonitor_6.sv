...
module TLMonitor_6(
  ...
  `ifndef SYNTHESIS
    ...
    wire             _GEN_44 = _T_2406 & same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire             _GEN_45 = _T_2406 & ~same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    ...
    wire  [2:0]      _T_2407 = inflight >> _GEN_43;	// @[Monitor.scala:611:27, :682:25]
    ...
    wire  [2:0]      _T_2493 = inflight_1 >> _GEN_43;	// @[Monitor.scala:682:25, :723:35, :793:25]
    ...
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (io_in_b_valid & ~reset & ~(io_in_b_bits_source == 2'h0 & io_in_b_bits_size == 4'h6 & io_in_b_bits_size < 4'hD & ({io_in_b_bits_address[31:15], io_in_b_bits_address[13:12]} == 19'h0 | io_in_b_bits_address[31:12] == 20'h3 | io_in_b_bits_address[31:16] == 16'h1 | {io_in_b_bits_address[31:17] ^ 15'h8, io_in_b_bits_address[15:12]} == 19'h0 | io_in_b_bits_address[31:16] == 16'h200 | io_in_b_bits_address[31:12] == 20'h2010 | io_in_b_bits_address[31:26] == 6'h3 | io_in_b_bits_address[31:12] == 20'h54000 | io_in_b_bits_address[31:29] == 3'h3 | io_in_b_bits_address[31:28] == 4'h8))) begin	// @[Bundles.scala:148:30, Monitor.scala:49:11, :168:75, :638:40, Mux.scala:27:73, Parameters.scala:46:9, :91:48, :92:42, :137:{31,45,65}, :672:42]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_GEN_38 & ~reset & ~(_T_2150 & (_WIRE_8_0 | _source_ok_WIRE_2_1 | _source_ok_WIRE_2_2) & _T_2141 & io_in_c_bits_address[31:28] == 4'h8)) begin	// @[Monitor.scala:42:11, :269:53, :270:78, Parameters.scala:46:9, :91:48, :92:42, :137:{31,65}, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
          $error("Assertion failed: 'C' channel carries ReleaseData type unsupported by manager (connected at SystemBus.scala:41:96)\n    at Monitor.scala:42 assert(cond, message)\n");	// @[Monitor.scala:42:11]
        if (`STOP_COND_)	// @[Monitor.scala:42:11]
          $fatal;	// @[Monitor.scala:42:11]
      end
      if (_GEN_38 & ~reset & ~(_WIRE_8_0 & _T_2141 & _T_2150 & (_GEN_36 == 19'h0 | io_in_c_bits_address[31:12] == 20'h3 | io_in_c_bits_address[31:16] == 16'h1 | _GEN_37 == 19'h0 | io_in_c_bits_address[31:16] == 16'h200 | io_in_c_bits_address[31:12] == 20'h2010 | io_in_c_bits_address[31:26] == 6'h3 | io_in_c_bits_address[31:12] == 20'h54000 | io_in_c_bits_address[31:29] == 3'h3 | io_in_c_bits_address[31:28] == 4'h8))) begin	// @[Bundles.scala:148:30, Monitor.scala:42:11, :269:53, :271:78, :638:40, Parameters.scala:46:9, :91:48, :92:42, :137:{31,45,65}, :672:42]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
          $error("Assertion failed: 'C' channel carries Release from a client which does not support Probe (connected at SystemBus.scala:41:96)\n    at Monitor.scala:42 assert(cond, message)\n");	// @[Monitor.scala:42:11]
        if (`STOP_COND_)	// @[Monitor.scala:42:11]
          $fatal;	// @[Monitor.scala:42:11]
      ...
      if (_T_2492 & ~same_cycle_resp_1 & ~reset & _GEN_46 != {1'h0, _c_size_lookup_T_1[7:1]}) begin	// @[Monitor.scala:49:11, :691:36, :747:{21,42}, :791:71, :792:88, :794:30, :797:36]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel contains improper response size (connected at SystemBus.scala:41:96)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
