...
module Queue_37(
  ...
  assign io_deq_bits_echo_tl_state_source = _ram_ext_R0_data[78:74];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_echo_extra_id = _ram_ext_R0_data[79];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_last = _ram_ext_R0_data[80];	// @[Decoupled.scala:273:95]
endmodule
