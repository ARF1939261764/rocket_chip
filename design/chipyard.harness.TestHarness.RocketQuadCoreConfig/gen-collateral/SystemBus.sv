...
module SystemBus(
  ...
  wire [4:0]  _coupler_to_port_named_mmio_port_axi4_auto_tl_in_d_bits_source;	// @[LazyModule.scala:489:27]
  ...
  wire [1:0]  _system_bus_xbar_auto_in_4_b_bits_source;	// @[SystemBus.scala:40:43]
  ...
  wire [1:0]  _system_bus_xbar_auto_in_4_d_bits_source;	// @[SystemBus.scala:40:43]
  ...
  TLFIFOFixer fixer (	// @[FIFOFixer.scala:146:27]
    ...
    .auto_in_4_b_ready         (auto_coupler_from_tile_tl_master_clock_xing_in_3_b_ready),
    .auto_in_4_c_valid         (auto_coupler_from_tile_tl_master_clock_xing_in_3_c_valid),
    .auto_in_4_c_bits_opcode   (auto_coupler_from_tile_tl_master_clock_xing_in_3_c_bits_opcode),
    .auto_in_4_c_bits_param    (auto_coupler_from_tile_tl_master_clock_xing_in_3_c_bits_param),
    .auto_in_4_c_bits_size     (auto_coupler_from_tile_tl_master_clock_xing_in_3_c_bits_size),
    .auto_in_4_c_bits_source   (auto_coupler_from_tile_tl_master_clock_xing_in_3_c_bits_source),
    .auto_in_4_c_bits_address  (auto_coupler_from_tile_tl_master_clock_xing_in_3_c_bits_address),
    .auto_in_4_c_bits_data     (auto_coupler_from_tile_tl_master_clock_xing_in_3_c_bits_data),
    .auto_in_4_c_bits_corrupt  (auto_coupler_from_tile_tl_master_clock_xing_in_3_c_bits_corrupt),
    .auto_in_4_d_ready         (auto_coupler_from_tile_tl_master_clock_xing_in_3_d_ready),
    .auto_in_4_e_valid         (auto_coupler_from_tile_tl_master_clock_xing_in_3_e_valid),
    .auto_in_4_e_bits_sink     (auto_coupler_from_tile_tl_master_clock_xing_in_3_e_bits_sink),
    ...
    .auto_in_1_c_bits_opcode   (auto_coupler_from_tile_tl_master_clock_xing_in_0_c_bits_opcode),
    .auto_in_1_c_bits_param    (auto_coupler_from_tile_tl_master_clock_xing_in_0_c_bits_param),
    .auto_in_1_c_bits_size     (auto_coupler_from_tile_tl_master_clock_xing_in_0_c_bits_size),
    .auto_in_1_c_bits_source   (auto_coupler_from_tile_tl_master_clock_xing_in_0_c_bits_source),
    .auto_in_1_c_bits_address  (auto_coupler_from_tile_tl_master_clock_xing_in_0_c_bits_address),
    .auto_in_1_c_bits_data     (auto_coupler_from_tile_tl_master_clock_xing_in_0_c_bits_data),
    .auto_in_1_c_bits_corrupt  (auto_coupler_from_tile_tl_master_clock_xing_in_0_c_bits_corrupt),
    ...
    .auto_in_1_e_bits_sink     (auto_coupler_from_tile_tl_master_clock_xing_in_0_e_bits_sink),
    ...
    .auto_in_4_b_valid         (auto_coupler_from_tile_tl_master_clock_xing_in_3_b_valid),
    .auto_in_4_b_bits_param    (auto_coupler_from_tile_tl_master_clock_xing_in_3_b_bits_param),
    .auto_in_4_b_bits_size     (auto_coupler_from_tile_tl_master_clock_xing_in_3_b_bits_size),
    .auto_in_4_b_bits_source   (auto_coupler_from_tile_tl_master_clock_xing_in_3_b_bits_source),
    .auto_in_4_b_bits_address  (auto_coupler_from_tile_tl_master_clock_xing_in_3_b_bits_address),
    .auto_in_4_c_ready         (auto_coupler_from_tile_tl_master_clock_xing_in_3_c_ready),
    ...
    .auto_in_4_e_ready         (auto_coupler_from_tile_tl_master_clock_xing_in_3_e_ready),
    ...
    .auto_in_3_e_ready         (auto_coupler_from_tile_tl_master_clock_xing_in_2_e_ready),
    ...
    .auto_in_2_e_ready         (auto_coupler_from_tile_tl_master_clock_xing_in_1_e_ready),
    .auto_in_1_a_ready         (auto_coupler_from_tile_tl_master_clock_xing_in_0_a_ready),
    .auto_in_1_b_valid         (auto_coupler_from_tile_tl_master_clock_xing_in_0_b_valid),
    .auto_in_1_b_bits_param    (auto_coupler_from_tile_tl_master_clock_xing_in_0_b_bits_param),
    .auto_in_1_b_bits_size     (auto_coupler_from_tile_tl_master_clock_xing_in_0_b_bits_size),
    .auto_in_1_b_bits_source   (auto_coupler_from_tile_tl_master_clock_xing_in_0_b_bits_source),
    .auto_in_1_b_bits_address  (auto_coupler_from_tile_tl_master_clock_xing_in_0_b_bits_address),
    .auto_in_1_c_ready         (auto_coupler_from_tile_tl_master_clock_xing_in_0_c_ready),
    ...
    .auto_in_1_e_ready         (auto_coupler_from_tile_tl_master_clock_xing_in_0_e_ready),
  ...
  TLInterconnectCoupler_7 coupler_to_port_named_mmio_port_axi4 (	// @[LazyModule.scala:489:27]
    .clock                          (_fixedClockNode_auto_out_0_clock),	// @[ClockGroup.scala:110:107]
    .reset                          (_fixedClockNode_auto_out_0_reset),	// @[ClockGroup.scala:110:107]
