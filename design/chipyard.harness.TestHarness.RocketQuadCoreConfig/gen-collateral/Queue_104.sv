...
module Queue_104(
  ...
  assign io_deq_bits_data_clients = _ram_ext_R0_data[19:16];	// @[Decoupled.scala:273:95]
  assign io_deq_bits_data_tag = _ram_ext_R0_data[31:20];	// @[Decoupled.scala:273:95]
endmodule
