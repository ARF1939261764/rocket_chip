...
module TLMonitor_22(
  ...
  wire         _T_1522 = io_in_a_ready & io_in_a_valid;	// @[Decoupled.scala:51:35]
  ...
  wire         _T_1446 = _T_1522 & a_first_1;	// @[Decoupled.scala:51:35, Edges.scala:231:25, Monitor.scala:652:27]
  ...
  wire [258:0] _a_opcodes_set_T_1 = {255'h0, _T_1446 ? {io_in_a_bits_opcode, 1'h1} : 4'h0} << {252'h0, io_in_a_bits_source, 2'h0};	// @[Monitor.scala:42:11, :643:40, :652:{27,72}, :654:{28,53}, :656:54, :657:52, OneHot.scala:64:12, Parameters.scala:52:29]
  wire [270:0] _d_sizes_clr_T_5 = 271'hFF << {263'h0, io_in_d_bits_source, 3'h0};	// @[Misc.scala:201:34, Monitor.scala:677:76, :678:74]
  wire [259:0] _a_sizes_set_T_1 = {255'h0, _T_1446 ? {io_in_a_bits_size, 1'h1} : 5'h0} << {252'h0, io_in_a_bits_source, 3'h0};	// @[Bundles.scala:259:74, Misc.scala:201:34, Monitor.scala:42:11, :645:38, :652:{27,72}, :655:{28,51}, :656:54, :657:52]
  wire         _T_1595 = io_in_d_ready & io_in_d_valid;	// @[Decoupled.scala:51:35]
  wire         _T_1461 = _T_1595 & d_first_1 & ~d_release_ack;	// @[Decoupled.scala:51:35, Edges.scala:231:25, Monitor.scala:670:46, :671:74, :675:72]
  always @(posedge clock) begin
    if (reset) begin
      ...
      if (_T_1522) begin	// @[Decoupled.scala:51:35]
      ...
      if (_T_1595) begin	// @[Decoupled.scala:51:35]
      ...
      inflight <= (inflight | (_T_1446 ? _a_set_T[30:0] : 31'h0)) & ~(_T_1461 ? _d_clr_T[30:0] : 31'h0);	// @[Monitor.scala:611:27, :623:34, :652:{27,72}, :653:28, :661:34, :675:{72,91}, :676:21, :702:{27,36,38}, :723:35, OneHot.scala:57:35]
      inflight_opcodes <= (inflight_opcodes | (_T_1446 ? _a_opcodes_set_T_1[123:0] : 124'h0)) & ~(_T_1461 ? _d_opcodes_clr_T_5[123:0] : 124'h0);	// @[Monitor.scala:613:35, :627:33, :652:{27,72}, :656:{28,54}, :665:33, :675:{72,91}, :677:{21,76}, :703:{43,60,62}, :724:35]
      inflight_sizes <= (inflight_sizes | (_T_1446 ? _a_sizes_set_T_1[247:0] : 248'h0)) & ~(_T_1461 ? _d_sizes_clr_T_5[247:0] : 248'h0);	// @[Monitor.scala:615:33, :629:31, :652:{27,72}, :657:{28,52}, :667:31, :675:{72,91}, :678:{21,74}, :704:{39,54,56}, :725:35]
      if (_T_1522 | _T_1595)	// @[Decoupled.scala:51:35, Monitor.scala:712:27]
        watchdog <= 32'h0;	// @[Monitor.scala:706:27]
      else	// @[Monitor.scala:712:27]
        watchdog <= watchdog + 32'h1;	// @[Monitor.scala:706:27, :711:26, OneHot.scala:57:35]
    end
    if (_T_1522 & ~(|a_first_counter)) begin	// @[Decoupled.scala:51:35, Edges.scala:229:27, :231:25, Monitor.scala:396:20]
    ...
    if (_T_1595 & ~(|d_first_counter)) begin	// @[Decoupled.scala:51:35, Edges.scala:229:27, :231:25, Monitor.scala:549:20]
  ...
  `ifndef SYNTHESIS
    ...
    wire             _T_542 = io_in_a_bits_size > 4'h2;	// @[Misc.scala:205:21]
    wire             mask_size = io_in_a_bits_size[1:0] == 2'h2;	// @[Bundles.scala:111:27, Misc.scala:208:26, OneHot.scala:63:49]
    wire             mask_acc = _T_542 | mask_size & ~(io_in_a_bits_address[2]);	// @[Misc.scala:205:21, :208:26, :209:26, :210:20, :214:{29,38}]
    wire             mask_acc_1 = _T_542 | mask_size & io_in_a_bits_address[2];	// @[Misc.scala:205:21, :208:26, :209:26, :214:{29,38}]
    ...
    wire             _T_239 = io_in_a_bits_size == 4'h6;	// @[Parameters.scala:91:48]
    ...
    wire             _T_456 = io_in_a_bits_size == 4'h6;	// @[Parameters.scala:91:48]
    wire             _GEN_11 = io_in_a_valid & io_in_a_bits_opcode == 3'h4;	// @[Monitor.scala:104:{25,45}]
    wire             _T_608 = io_in_a_bits_size < 4'hD;	// @[Parameters.scala:92:42]
    ...
    wire             _T_723 = io_in_a_bits_size < 4'hD;	// @[Parameters.scala:92:42]
    ...
    wire             _T_1391 = io_in_a_valid & (|a_first_counter);	// @[Edges.scala:229:27, :231:25, Monitor.scala:389:19]
    wire             _T_1415 = io_in_d_valid & (|d_first_counter);	// @[Edges.scala:229:27, :231:25, Monitor.scala:541:19]
    wire  [123:0]    _a_opcode_lookup_T_1 = inflight_opcodes >> {117'h0, io_in_d_bits_source, 2'h0};	// @[Monitor.scala:613:35, :634:44, OneHot.scala:64:12]
    wire  [247:0]    _GEN_26 = {240'h0, io_in_d_bits_source, 3'h0};	// @[Misc.scala:201:34, Monitor.scala:638:40]
    ...
    wire             _T_1494 = io_in_d_valid & d_first_1;	// @[Edges.scala:231:25, Monitor.scala:671:26]
    wire             _T_1465 = _T_1494 & ~d_release_ack;	// @[Monitor.scala:670:46, :671:{26,74}, :680:71]
    wire             same_cycle_resp = _same_cycle_resp_T_1 & io_in_a_bits_source == io_in_d_bits_source;	// @[Monitor.scala:648:26, :681:{88,113}]
    wire  [30:0]     _GEN_27 = {26'h0, io_in_d_bits_source};	// @[Monitor.scala:658:26, :682:25]
    wire             _GEN_28 = _T_1465 & same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire             _GEN_29 = _T_1465 & ~same_cycle_resp;	// @[Monitor.scala:680:71, :681:88, :684:30]
    wire  [7:0]      _GEN_30 = {4'h0, io_in_d_bits_size};	// @[Monitor.scala:691:36, Parameters.scala:52:29]
    wire             _T_1551 = io_in_d_valid & d_first_2 & d_release_ack;	// @[Edges.scala:231:25, Monitor.scala:670:46, :791:71]
    wire  [30:0]     _T_1447 = inflight >> io_in_a_bits_source;	// @[Monitor.scala:611:27, :658:26]
    wire  [30:0]     _T_1466 = inflight >> _GEN_27;	// @[Monitor.scala:611:27, :682:25]
    wire  [247:0]    _a_size_lookup_T_1 = inflight_sizes >> _GEN_26;	// @[Monitor.scala:615:33, :638:40]
    wire  [31:0]     _d_clr_wo_ready_T = 32'h1 << _GEN_1;	// @[OneHot.scala:57:35]
    wire  [30:0]     _T_1552 = 31'h0 >> _GEN_27;	// @[Monitor.scala:682:25, :723:35, :793:25]
    wire  [247:0]    _c_size_lookup_T_1 = 248'h0 >> _GEN_26;	// @[Monitor.scala:638:40, :725:35, :747:42]
    always @(posedge clock) begin	// @[Monitor.scala:42:11]
      ...
      if (_GEN_6 & ~reset & ~((_WIRE_2_1 & _T_239 | _WIRE_2_4 & _T_239 | _WIRE_2_7 & _T_239 | _WIRE_2_10 & _T_239) & io_in_a_bits_size < 4'hD & (_GEN_7 == 18'h0 | io_in_a_bits_address[30:12] == 19'h3 | io_in_a_bits_address[30:16] == 15'h1 | _GEN_8 == 18'h0 | io_in_a_bits_address[30:16] == 15'h200 | io_in_a_bits_address[30:12] == 19'h2010 | io_in_a_bits_address[30:26] == 5'h3 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :81:54, :83:78, :706:27, Mux.scala:27:73, Parameters.scala:46:9, :91:48, :92:42, :137:{31,45,65}, :672:42]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_6 & ~reset & ~_T_542) begin	// @[Misc.scala:205:21, Monitor.scala:42:11, :81:54]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & ~((_WIRE_2_1 & _T_456 | _WIRE_2_4 & _T_456 | _WIRE_2_7 & _T_456 | _WIRE_2_10 & _T_456) & io_in_a_bits_size < 4'hD & (_GEN_7 == 18'h0 | io_in_a_bits_address[30:12] == 19'h3 | io_in_a_bits_address[30:16] == 15'h1 | _GEN_8 == 18'h0 | io_in_a_bits_address[30:16] == 15'h200 | io_in_a_bits_address[30:12] == 19'h2010 | io_in_a_bits_address[30:26] == 5'h3 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :92:53, :94:78, :706:27, Mux.scala:27:73, Parameters.scala:46:9, :91:48, :92:42, :137:{31,45,65}, :672:42]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_10 & ~reset & ~_T_542) begin	// @[Misc.scala:205:21, Monitor.scala:42:11, :92:53]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_11 & ~reset & ~(_T_608 & (~(io_in_a_bits_source[4]) | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _WIRE_2_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _WIRE_2_7 | _source_ok_WIRE_8 | _source_ok_WIRE_9 | _WIRE_2_10 | _source_ok_WIRE_11 | _source_ok_WIRE_12))) begin	// @[Monitor.scala:42:11, :104:45, Parameters.scala:46:9, :54:{10,32}, :92:42, :1161:30, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_13 & ~reset & ~(_T_723 & (~(io_in_a_bits_source[4]) | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _WIRE_2_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _WIRE_2_7 | _source_ok_WIRE_8 | _source_ok_WIRE_9 | _WIRE_2_10 | _source_ok_WIRE_11 | _source_ok_WIRE_12) & (_T_723 & io_in_a_bits_address[30:12] == 19'h3 | io_in_a_bits_size < 4'h7 & (_GEN_7 == 18'h0 | _GEN_8 == 18'h0 | io_in_a_bits_address[30:16] == 15'h200 | io_in_a_bits_address[30:12] == 19'h2010 | io_in_a_bits_address[30:26] == 5'h3 | io_in_a_bits_address[30:12] == 19'h54000)))) begin	// @[Monitor.scala:42:11, :114:53, :115:71, :706:27, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:{31,45,65}, :671:54, :672:42, :673:26, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_14 & ~reset & ~(_T_837 & (~(io_in_a_bits_source[4]) | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _WIRE_2_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _WIRE_2_7 | _source_ok_WIRE_8 | _source_ok_WIRE_9 | _WIRE_2_10 | _source_ok_WIRE_11 | _source_ok_WIRE_12) & (_T_837 & io_in_a_bits_address[30:12] == 19'h3 | io_in_a_bits_size < 4'h7 & (_GEN_7 == 18'h0 | _GEN_8 == 18'h0 | io_in_a_bits_address[30:16] == 15'h200 | io_in_a_bits_address[30:12] == 19'h2010 | io_in_a_bits_address[30:26] == 5'h3 | io_in_a_bits_address[30:12] == 19'h54000)))) begin	// @[Monitor.scala:42:11, :122:56, :123:74, :706:27, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:{31,45,65}, :671:54, :672:42, :673:26, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_15 & ~reset & ~(io_in_a_bits_size < 4'hD & (~(io_in_a_bits_source[4]) | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _WIRE_2_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _WIRE_2_7 | _source_ok_WIRE_8 | _source_ok_WIRE_9 | _WIRE_2_10 | _source_ok_WIRE_11 | _source_ok_WIRE_12) & io_in_a_bits_size < 4'h4 & (_GEN_7 == 18'h0 | io_in_a_bits_address[30:12] == 19'h3 | _GEN_8 == 18'h0 | io_in_a_bits_address[30:16] == 15'h200 | io_in_a_bits_address[30:12] == 19'h2010 | io_in_a_bits_address[30:26] == 5'h3 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :130:56, :131:74, :706:27, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:{31,45,65}, :672:42, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_16 & ~reset & ~(io_in_a_bits_size < 4'hD & (~(io_in_a_bits_source[4]) | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _WIRE_2_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _WIRE_2_7 | _source_ok_WIRE_8 | _source_ok_WIRE_9 | _WIRE_2_10 | _source_ok_WIRE_11 | _source_ok_WIRE_12) & io_in_a_bits_size < 4'h4 & (_GEN_7 == 18'h0 | io_in_a_bits_address[30:12] == 19'h3 | _GEN_8 == 18'h0 | io_in_a_bits_address[30:16] == 15'h200 | io_in_a_bits_address[30:12] == 19'h2010 | io_in_a_bits_address[30:26] == 5'h3 | io_in_a_bits_address[30:12] == 19'h54000))) begin	// @[Monitor.scala:42:11, :138:53, :139:71, :706:27, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:{31,45,65}, :672:42, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_GEN_17 & ~reset & ~(io_in_a_bits_size < 4'hD & (~(io_in_a_bits_source[4]) | _WIRE_2_1 | _source_ok_WIRE_2 | _source_ok_WIRE_3 | _WIRE_2_4 | _source_ok_WIRE_5 | _source_ok_WIRE_6 | _WIRE_2_7 | _source_ok_WIRE_8 | _source_ok_WIRE_9 | _WIRE_2_10 | _source_ok_WIRE_11 | _source_ok_WIRE_12) & io_in_a_bits_address[30:12] == 19'h3)) begin	// @[Monitor.scala:42:11, :146:46, :147:68, Parameters.scala:46:9, :54:{10,32}, :92:42, :137:{31,65}, :1162:43]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:42:11]
      ...
      if (_T_1494 & a_first_1 & io_in_a_valid & io_in_a_bits_source == io_in_d_bits_source & ~d_release_ack & ~reset & ~(~io_in_d_ready | io_in_a_ready)) begin	// @[Edges.scala:231:25, Monitor.scala:49:11, :670:46, :671:{26,74}, :694:90, :695:{15,32}]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: ready check\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (~reset & ~(a_set_wo_ready != (_T_1494 & ~d_release_ack ? _d_clr_wo_ready_T[30:0] : 31'h0) | a_set_wo_ready == 31'h0)) begin	// @[Monitor.scala:49:11, :624:34, :648:71, :649:22, :662:34, :670:46, :671:{26,71,74,90}, :672:22, :699:{29,48,67}, :723:35, OneHot.scala:57:35]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
      ...
      if (_T_1551 & ~reset & ~(_T_1552[0])) begin	// @[Monitor.scala:49:11, :791:71, :793:25]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel acknowledged for nothing inflight (connected at CrossingHelper.scala:30:14)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
      end
      if (_T_1551 & ~reset & _GEN_30 != {1'h0, _c_size_lookup_T_1[7:1]}) begin	// @[Monitor.scala:42:11, :49:11, :691:36, :747:{21,42}, :791:71, :797:36]
        if (`ASSERT_VERBOSE_COND_)	// @[Monitor.scala:49:11]
          $error("Assertion failed: 'D' channel contains improper response size (connected at CrossingHelper.scala:30:14)\n    at Monitor.scala:49 assert(cond, message)\n");	// @[Monitor.scala:49:11]
        if (`STOP_COND_)	// @[Monitor.scala:49:11]
          $fatal;	// @[Monitor.scala:49:11]
    ...
    initial begin
      ...
      `ifdef RANDOMIZE_REG_INIT
        ...
        inflight = {_RANDOM_2[31:16], _RANDOM_3[14:0]};	// @[Monitor.scala:535:22, :611:27]
        inflight_opcodes = {_RANDOM_3[31:15], _RANDOM_4, _RANDOM_5, _RANDOM_6, _RANDOM_7[10:0]};	// @[Monitor.scala:611:27, :613:35]
        inflight_sizes = {_RANDOM_7[31:11], _RANDOM_8, _RANDOM_9, _RANDOM_10, _RANDOM_11, _RANDOM_12, _RANDOM_13, _RANDOM_14, _RANDOM_15[2:0]};	// @[Monitor.scala:613:35, :615:33]
        a_first_counter_1 = _RANDOM_15[11:3];	// @[Edges.scala:229:27, Monitor.scala:615:33]
        d_first_counter_1 = _RANDOM_15[20:12];	// @[Edges.scala:229:27, Monitor.scala:615:33]
        watchdog = {_RANDOM_15[31:21], _RANDOM_16[20:0]};	// @[Monitor.scala:615:33, :706:27]
        d_first_counter_2 = _RANDOM_29[25:17];	// @[Edges.scala:229:27]
      `endif // RANDOMIZE_REG_INIT
    end // initial
